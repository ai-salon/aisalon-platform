      ...
      <footer id="landing-footer">
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              {[
                ...
                <li key={label} style={{ marginBottom: 12 }}>
                  <a href={href} style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", transition: "all 0.3s ease" }}>
                    {label}
                  </a>
                </li>
              ))}
        ...
        <div style={{ textAlign: "center", padding: "25px 30px" }}>
          <p style={{ margin: 0, fontSize: 13, color: "rgba(255,255,255,0.5)" }}>
            © 2025 Ai Salon. All rights reserved. | Shaping the future of AI together.
          </p>
        </div>
        ...
        {(health || error) && (
          <div style={{ textAlign: "center", paddingBottom: 12 }}>
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)" }}>
              API: {error ? "disconnected" : `v${health?.version}`}
            </span>
          </div>
        )}
      </footer>
